...
const ERROR_CODE_TO_I18N_KEY: Record<string, string> = {
  ...
  SECTION_NAME_DUPLICATE: 'errors.section.nameDuplicate',
  LECTURE_TITLE_DUPLICATE: 'errors.lecture.titleDuplicate',
  RESOURCE_LABEL_DUPLICATE: 'errors.resource.labelDuplicate',
  RESOURCE_URL_DUPLICATE: 'errors.resource.urlDuplicate',
  RESOURCE_URL_INVALID: 'errors.resource.urlInvalid',
  PROFILE_EMAIL_DUPLICATE: 'errors.profile.emailDuplicate',
  PROFILE_STUDENT_ID_DUPLICATE: 'errors.profile.studentIdDuplicate',
  CALENDAR_TIME_RANGE_INVALID: 'errors.calendar.timeRangeInvalid',
  CALENDAR_EVENT_TIME_CONFLICT: 'errors.calendar.timeConflict',
